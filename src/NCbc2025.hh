#ifndef NCPlugin_bc2025_hh
#define NCPlugin_bc2025_hh
...
///  Refs: T. Kittelmann et al., Acta Cryst. (2026). A82, 163-178            ///
///        https://doi.org/10.1107/S2053273326001245                         ///
///        Thomas Kittelmann. (2026). tkittel/bc-extinction-paper:           ///
///        Supporting material for BC extinction recipe updates v1.0.1       ///
///        (v1.0.1). Zenodo. https://doi.org/10.5281/zenodo.18493059         ///
////////////////////////////////////////////////////////////////////////////////

inline double bc2025_y_primary( double x, double sintheta )
{
  double y0;
  if ( x < 0.1 ) {
...
inline double bc2025_y_scndgauss( double x, double sintheta )
{
  double y0;
  if ( x < 0.1 ) {
...
inline double bc2025_y_scndlorentz( double x, double sintheta )
{
  double y0;
  if ( x < 0.1 ) {
...
inline double bc2025_y_scndfresnel( double x, double sintheta )
{
  double y0;
  if ( x < 0.1 ) {
...
inline double bc2025_y_primary_lux( double x, double sintheta )
{
  double y0;
  if ( x < 0.02 ) {
...
inline double bc2025_y_scndgauss_lux( double x, double sintheta )
{
  double y0;
  if ( x < 0.02 ) {
...
inline double bc2025_y_scndlorentz_lux( double x, double sintheta )
{
  double y0;
  if ( x < 0.02 ) {
...
inline double bc2025_y_scndfresnel_lux( double x, double sintheta )
{
  double y0;
  if ( x < 0.02 ) {
